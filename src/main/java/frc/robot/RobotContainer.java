...
public class RobotContainer {
  ...
  private final Command m_DriveDistance = new DriveDistance(0, 0, m_driveBase);
  private final Command m_DriveBackwards = new DriveBackwards(48,0.5,m_driveBase);
  /* ---Controllers--- */
...
private String Selected;
  ...
  AutoSelector.addOption("Score and leave", ScoreSpeakerAndLeave);
  AutoSelector.addOption("Drive a Distance Backwards", DriveDistance);
